...
var program = commander
	...
	.option('--input <file>', 'Specify an input data file (can be used multiple times)', (v, t) => t.concat([v]), [])
	.option('--output <file>', 'Specify an output data file (can be used multiple times)', (v, t) => t.concat([v]), [])
